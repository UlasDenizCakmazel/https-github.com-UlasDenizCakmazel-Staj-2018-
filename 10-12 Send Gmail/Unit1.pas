...
begin
  ...
  RichEdit1.Text:=(IniF.ReadString('POSTA','Icerik','Bos Geldi')); //RichEdit1.text:='içerik';
  ...
  IdMessage1.Free;
  IdSSLIOHandlerSocketOpenSSL1.Free;
  ShowMessage('Mail otomatik olarak baþarýyla gönderildi...');
  end
  else ShowMessage('Otomatik gönderme aktif deðil... Lütfen butonlarý kullanarak manuel olarak gönderiniz...');
