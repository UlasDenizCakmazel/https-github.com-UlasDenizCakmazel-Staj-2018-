...
begin
  ...
  begin
    ...
    try
      ...
      application.Title := 'Kayýt Cihazý Desteklenmiyor veya Cihaza Eriþim Ýzniniz Yok';
  ...
  begin
    application.Title := 'Kayýt cihazý yok';
